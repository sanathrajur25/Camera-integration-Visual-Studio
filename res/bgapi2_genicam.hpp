...
*    Purpose:       Baumer GenTL consumer C++ Interface
*
*    Created:        13.04.2011
...
namespace BGAPI2
{
    ...
    */
    ...
    public:
        ...
        * \brief     This function creates and delivers a specified static instance of SystemList. The passed parameter sets a new searching path for GenTL producer. See function SystemList::Refresh for the searching path description.
        ...
        */
        ...
        /**
        * \fn        Refresh
        * \brief     This functions starts the search for GenTL producers with file extension 'cti' and follows a fixed searching procedure. First, the current working directory is searched and then the directories specified in the GenICam variable (see remarks). By using the function SystemList::CreateInstanceFromPath the GenICam variable will be ignored and the specified path is used instead. The found GenTL producers will be inserted into the SystemList.
        * \return    void
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        GetTimestamp
        * \brief     This function delivers the timestamp of the image. The basic requirement for this function is that the Buffer object needs valid image data. See also the exception description of Exceptions::LowLevelException.
    ...
    */
    ...
    public:
        ...
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        * \remarks   The stacked mode is a high-performance method for transmitting write commands (control commands) to the device. The control commands were packed into one packet an transmitted as concatenated command. The stacked mode is started by calling the function Device::StartStacking. All following control commands were collected and will not transmitted until the calling of Device::WriteStack. After calling Device::WriteStack the stacked mode is stopped.
        */
        void WriteStack();
        ...
        * \param     name The requested feature of the remote device. For standardised features the predefined items in bgapi2_featurenames.h should be used.
    ...
    */
    ...
    private:
        ...
        Image( const ImageProcessor &Obj );
        ~Image();
    ...
    */
    namespace Exceptions
    {
        ...
        */
        class BGAPI2_DECL ErrorException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL NotInitializedException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL NotImplementedException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL ResourceInUseException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL AccessDeniedException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL InvalidHandleException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL NoDataException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL InvalidParameterException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL AbortException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL InvalidBufferException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL NotAvailableException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL ObjectInvalidException : public IException
        {
        public:
        ...
        */
        class BGAPI2_DECL LowLevelException : public IException
        {
        public:
